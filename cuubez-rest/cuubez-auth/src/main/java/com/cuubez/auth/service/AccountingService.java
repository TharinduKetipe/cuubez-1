...
public class AccountingService {
	...
	public void account(String userId, String roleId, AccountAction accountAction, String serviceName, AccountOutcome accountOutcome) throws AccountingException{
		
		AccountEntry accountEntry = new AccountEntry(userId, roleId, accountAction, serviceName, accountOutcome);
		try {
			accountingConnector.account(accountEntry);//TODO check accountingConnector for null when failing to create connector
