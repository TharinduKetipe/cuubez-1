...
public class FileAccountingConnector implements AccountingConnector {
	 ...
	 * 
	 */
    public FileAccountingConnector(boolean failOnAccountError, boolean guaranteedAccount)
     ...
     * (non-Javadoc)
     * @see
     * com.cuubez.auth.connector.AccountingConnector#account(com.cuubez.auth.model.AccountEntry)
     */
     ...
     * @throws AccountingConnectorException
     */
    public static FileAccountingConnector getInstance(boolean failOnAccountError, boolean guaranteedAccount)
            throws AccountingConnectorException {
